...
const leaderboard: DriverEntry[] = [
  { pos: 1, code: "VER", gap: "LEADER", interval: "-", tire: "M", teamColor: "#3671C6" },
  { pos: 2, code: "HAM", gap: "+1.245", interval: "+1.245", tire: "M", teamColor: "#E8002D" },
  { pos: 3, code: "NOR", gap: "+4.582", interval: "+3.337", tire: "S", teamColor: "#FF8700" },
  { pos: 4, code: "LEC", gap: "+5.120", interval: "+0.538", tire: "M", teamColor: "#E8002D" },
  { pos: 5, code: "PIA", gap: "+8.901", interval: "+3.781", tire: "S", teamColor: "#FF8700" },
  { pos: 6, code: "RUS", gap: "+10.234", interval: "+1.333", tire: "H", teamColor: "#27F4D2" },
  { pos: 7, code: "SAI", gap: "+12.455", interval: "+2.221", tire: "M", teamColor: "#E8002D" },
  { pos: 8, code: "ALO", gap: "+15.678", interval: "+3.223", tire: "H", teamColor: "#229971" },
];
  ...
  return (
    <div className="glass rounded-xl overflow-hidden flex flex-col h-full">
      <div className="bg-white/5 px-4 py-3 flex items-center justify-between border-b border-white/10">
        ...
        <span className="text-[10px] font-black uppercase tracking-widest text-f1-red">Lap 42/71</span>
      </div>
      <div className="flex-1 overflow-y-auto no-scrollbar">
        {leaderboard.map((driver, idx) => (
          <motion.div 
            ...
            key={driver.code} 
            className="flex items-center gap-3 px-4 py-3 hover:bg-white/5 transition-colors group cursor-pointer border-b border-white/5 last:border-0"
          >
